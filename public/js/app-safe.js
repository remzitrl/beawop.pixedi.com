...
/* ---------------------------> 
    AOS - Initialized in React hook
<--------------------------- */
// AOS is now initialized in useScripts hook for better timing control
...
$(document).ready(function () {
  if ($(".cases__slider3-slider").length > 0) {
...
<--------------------------- */
$(document).ready(function () {
  if ($(".testimonial__body-slider").length > 0) {
...
$(document).ready(function () {
  if ($(".testimonial__body-slider2").length > 0) {
...
$(document).ready(function () {
  if ($(".testimonial__body-slider3").length > 0) {
...
<--------------------------- */
$(document).ready(function () {
  if ($(".swiper").length > 0 && typeof Swiper !== 'undefined') {
    new Swiper(".mySwiper", {
      slidesPerView: "auto",
      spaceBetween: 30,
      loop: true,
