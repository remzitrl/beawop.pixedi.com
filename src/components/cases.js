                    ...
                    <div className="cases__slider">
                        <div className="card cases__card">
                            <div className="cases__card-img" style={{height: '240px', overflow: 'hidden', position: 'relative'}}>
                                <img className="img-fluid w-100" src="/assets/img/cas1.webp" alt="image" style={{height: '100%', objectFit: 'cover'}} />
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <div className="cases__card-range--bottom">
                                            ...
                                            <div className="d-flex align-items-center gap-2">
                                                <img className="cases__card-range--dollar" src="/assets/img/dollar-s.svg"
                                                    alt="icon" />
                                                <span className="cases__card-range--price">Goal: $50,000</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="card cases__card">
                            <div className="cases__card-img" style={{height: '240px', overflow: 'hidden', position: 'relative'}}>
                                <img className="img-fluid w-100" src="/assets/img/cas2.webp" alt="image" style={{height: '100%', objectFit: 'cover'}} />
                                <h4 className="cases__card-tag">Current Campaigns</h4>
                            </div>
                            <div className="card-body px-4">
                                <div className="d-flex">
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <div className="cases__card-range--bottom">
                                            ...
                                            <div className="d-flex align-items-center gap-2">
                                                <img className="cases__card-range--dollar" src="/assets/img/dollar-s.svg"
                                                    alt="icon" />
                                                <span className="cases__card-range--price">Goal: $25,000</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="card cases__card">
                            <div className="cases__card-img" style={{height: '240px', overflow: 'hidden', position: 'relative'}}>
                                <img className="img-fluid w-100" src="/assets/img/cas3.webp" alt="image" style={{height: '100%', objectFit: 'cover'}} />
                                <h4 className="cases__card-tag">Current Campaigns</h4>
                            </div>
                            <div className="card-body px-4">
                                <div className="d-flex">
                                ...
                                <div className="cases__card-range d-flex flex-column">
                                    ...
                                    <div className="text-center mt-auto pt-3">
                                        <button className="global__btn w-100">Volunteer
                        ...
                        <div className="card cases__card">
                            <div className="cases__card-img" style={{height: '240px', overflow: 'hidden', position: 'relative'}}>
                                <img className="img-fluid w-100" src="/assets/img/cas4.webp" alt="image" style={{height: '100%', objectFit: 'cover'}} />
                            ...
                            <div className="card-body px-4">
                                ...
                                <div className="cases__card-range d-flex flex-column">
                                    ...
                                    <div className="text-center mt-auto pt-3">
                                        <button className="global__btn w-100">Join Mailing List
                                            <i className="fa-solid fa-arrow-up-long global__btn-arrow"></i>
                                        </button>
                                    </div>
                                </div>
